...
void NoSleepHomeworkExtra()
{//In This one, you go to work tired, but you got all homework done.
	cout << "\n\n\nYour alarm causes you to drag yourself out of bed...\n";
	cout << "You make it to work... however, because of your grogginess you fall asleep at work...\n";
	cout << "This causes a safety accident, leading to the end of your career...\n\n\n\n\n";
}
void NoSleepExtraExtraHomework()
{//In this one, you skip work, and get extra homework done, after staying up to get homework done.
	cout << "\n\n\nAfter staying up late to get homework done, you get up early...\n";
	cout << "You are a beast... Nothing can stop you! Your grades are literally perfect!\n";
	cout << "You finally check your phone to find a voicemail... You no longer have a job...\n\n\n\n";
}
void NoSleepExtraHomework()
{//In this one, you stay up to get homework done, but dont go to work.
	cout << "\n\n\nWhile you went to bed early and got plenty of sleep....\n";
	cout << "You feel as if you did nothing... and this is true.\n";
	cout << "You check your phone to many missed calls...\n";
	cout << "You listen to a voicemail to find out that you no longer have a job.\n\n\n\n";
